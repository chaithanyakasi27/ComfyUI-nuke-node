...
def check_dependencies():
    ...
    if pytorch_missing:
        print(
            " PyTorch is missing. This usually means ComfyUI is not properly installed."
        )
...
def show_version_info():
    ...
    try:
        ...
        print(f"  Node Categories: {', '.join(version_info['node_categories'])}")
    except Exception as e:
...
def main():
    ...
    if missing:
        ...
        if install.lower() == "y":
            ...
            print("  Some dependencies are missing. Nodes may not work properly.")
